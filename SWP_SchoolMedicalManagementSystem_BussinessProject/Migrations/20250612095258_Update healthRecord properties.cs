...
{
    /// <inheritdoc />
    public partial class UpdatehealthRecordproperties : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HealthCheckupCampaignsId = table.Column<Guid>(type: "uuid", nullable: false),
                    MedicalStaffsId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HealthCheckupCampaignUser", x => new { x.HealthCheckupCampaignsId, x.MedicalStaffsId });
                    table.ForeignKey(
                        name: "FK_HealthCheckupCampaignUser_HealthCheckupCampaigns_HealthChec~",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    MedicalStaffsId = table.Column<Guid>(type: "uuid", nullable: false),
                    VaccinationCampaignsId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserVaccinationCampaign_VaccinationCampaigns_VaccinationCam~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HealthCheckupCampaignId = table.Column<Guid>(type: "uuid", nullable: true),
                    StudentId = table.Column<Guid>(type: "uuid", nullable: false),
                    ConsentStatus = table.Column<bool>(type: "boolean", nullable: false),
                    ConsentDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ReasonForDecline = table.Column<string>(type: "text", nullable: true),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true),
                    CreateAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdateAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HealthCheckupConsentForms_HealthCheckupCampaigns_HealthChec~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisionLeft = table.Column<string>(type: "text", nullable: true),
                    VisionRight = table.Column<string>(type: "text", nullable: true),
                    HearingLeft = table.Column<string>(type: "text", nullable: true),
                    HearingRight = table.Column<string>(type: "text", nullable: true),
                    VaccinationHistory = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentNotificationDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true),
                    CreateAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdateAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantity = table.Column<int>(type: "integer", nullable: false),
                    MedicalStaffNotes = table.Column<string>(type: "text", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentHealthCheckupSchedules_HealthCheckupCampaigns_Health~",
                        column: x => x.HealthCheckupCampaignId,
                        principalTable: "HealthCheckupCampaigns",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    CampaignId = table.Column<Guid>(type: "uuid", nullable: false),
                    VaccinationCampaignId = table.Column<Guid>(type: "uuid", nullable: true),
                    StudentId = table.Column<Guid>(type: "uuid", nullable: false),
                    ScheduledDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Location = table.Column<string>(type: "text", nullable: true),
                    Notes = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_StudentVaccinationSchedules_VaccinationCampaigns_Vaccinatio~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_VaccinationConsentForms_VaccinationCampaigns_VaccinationCam~",
                        column: x => x.VaccinationCampaignId,
                        principalTable: "VaccinationCampaigns",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HealthCheckupScheduleId = table.Column<Guid>(type: "uuid", nullable: true),
                    CheckupDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Height = table.Column<float>(type: "real", nullable: true),
                    Weight = table.Column<float>(type: "real", nullable: true),
                    VisionLeftResult = table.Column<string>(type: "text", nullable: true),
                    VisionRightResult = table.Column<string>(type: "text", nullable: true),
                    HearingLeftResult = table.Column<string>(type: "text", nullable: true),
                    HearingRightResult = table.Column<string>(type: "text", nullable: true),
                    ...
                    DentalCheckupResult = table.Column<string>(type: "text", nullable: true),
                    OtherResults = table.Column<string>(type: "text", nullable: true),
                    AbnormalSigns = table.Column<string>(type: "text", nullable: true),
                    Recommendations = table.Column<string>(type: "text", nullable: true),
                    ParentResultNotified = table.Column<bool>(type: "boolean", nullable: false),
                    ParentResultNotificationDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true),
                    CreateAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdateAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HealthCheckupResults_StudentHealthCheckupSchedules_HealthCh~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ScheduleId = table.Column<Guid>(type: "uuid", nullable: false),
                    VaccinationScheduleId = table.Column<Guid>(type: "uuid", nullable: true),
                    VaccinationDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    DosageGiven = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VaccinationResults_StudentVaccinationSchedules_VaccinationS~",
